...
async function testIgMediaDetail(shortcode) {
  ...
  console.log('Caption:', media.edge_media_to_caption?.edges[0]?.node?.text);
  console.log('Owner:', media.owner?.username);
  console.log('Video View Count:', media.video_view_count);
}

testIgMediaDetail('C8xL_9vS_qM');
